...
$autoloader->addClassFiles([
	'XLSXWriter'                => SRC_PATH . '/lib/php-xlsxwriter/src/XLSXWriter.php',
	'XLSXWriter_BuffererWriter' => SRC_PATH . '/lib/php-xlsxwriter/src/XLSXWriter_BuffererWriter.php',
