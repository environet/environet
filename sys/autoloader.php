 ...
 * Class Loader
 *
 * A PSR-4 standard SPL autoloader
 *
...
class Loader {
	...
	/**
	 * Get and/or create the loader instance
	 */
	 ...
	 * @throws Exception
	 */
	public function loadIncFile(string $file) {
		if (!file_exists($file)) {
	 ...
	 * @throws Exception
	 */
	public function loadIncFiles(array $files = []) {
		foreach ($files as $file) {
			$this->loadIncFile($file);
		}
	}
