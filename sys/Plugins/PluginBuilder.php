...
use Environet\Sys\Plugins\Transports\FtpDirectoryTransport;
...
class PluginBuilder {
	...
	public function __construct() {
		$this->layers = [
			new PluginLayer(
				'transport',
				[HttpTransport::class, HttpTransportExtended::class, LocalFileTransport::class, LocalDirectoryTransport::class, FtpDirectoryTransport::class],
