...
class AdminHandler extends BaseHandler {
	...
	protected static $pages = [
		...
		'^warning-level-groups$'        => [WarningLevelGroupCrud::class, 'list', ['admin.warninglevels.read'], ['admin.warninglevels.readown']],
		'^warning-level-groups\/show$'  => [WarningLevelGroupCrud::class, 'show', ['admin.warninglevels.read'], ['admin.warninglevels.readown']],
		'^warning-level-groups\/add$'   => [WarningLevelGroupCrud::class, 'add', ['admin.warninglevels.create'], ['admin.warninglevels.createown']],
		'^warning-level-groups\/edit$'  => [WarningLevelGroupCrud::class, 'edit', ['admin.warninglevels.update'], ['admin.warninglevels.updateown']],
		'^warning-level-groups\/delete' => [WarningLevelGroupCrud::class, 'delete', ['admin.warninglevels.delete'], ['admin.warninglevels.deleteown']],

		'^warning-levels$'        => [WarningLevelCrud::class, 'list', ['admin.warninglevelgroups.read']],
		'^warning-levels\/show$'  => [WarningLevelCrud::class, 'show', ['admin.warninglevelgroups.read']],
		'^warning-levels\/add$'   => [WarningLevelCrud::class, 'add', ['admin.warninglevelgroups.create']],
		'^warning-levels\/edit$'  => [WarningLevelCrud::class, 'edit', ['admin.warninglevelgroups.update']],
		'^warning-levels\/delete' => [WarningLevelCrud::class, 'delete', ['admin.warninglevelgroups.delete']],
